...
function gestionFila() {
    ...
    let nombreEntró = alumnos.shift();
    alert("Entró " + nombreEntró + " y la fila ahora es: " + alumnos.join(", "));
}
gestionFila();
...
function coordenadasMatriz() {
    ...
    let numeroUno = matriz[0][0];
    let numeroDos = matriz[1][1];
    alert("Suma de [0][0] y [1][1]: " + (numeroUno + numeroDos));
}
coordenadasMatriz();
...
function traducirAcciones() {
    ...
    let verbos = [["codifica", "analiza"], ["falla", "reirnicia"]];
